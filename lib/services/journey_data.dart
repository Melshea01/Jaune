...
const List<LevelUnlock> kLevelUnlocks = [
  ...
  LevelUnlock(11, 1, UnlockType.collectible, 'lvl_11', '🌼', 'Fleur des champs',
      'Wildflower', 'La vie éclôt autour de toi.', 'Life blooms around you.'),
  ...
  LevelUnlock(31, 2, UnlockType.collectible, 'lvl_31', '🐠', 'Banc de poissons',
      'School of fish', 'On va plus loin ensemble.', 'Together we go further.'),
  ...
  LevelUnlock(47, 3, UnlockType.collectible, 'lvl_47', '🦌', 'Le cerf',
      'The deer', 'La grâce dans l\'effort.', 'Grace within the effort.'),
  ...
  LevelUnlock(71, 4, UnlockType.collectible, 'lvl_71', '🛵', 'Le scooter',
      'The scooter', 'File vers tes objectifs.', 'Zip toward your goals.'),
  ...
  LevelUnlock(76, 4, UnlockType.collectible, 'lvl_76', '🚇', 'Le métro',
      'The subway', 'Toujours en mouvement.', 'Always moving forward.'),
  ...
  LevelUnlock(91, 5, UnlockType.collectible, 'lvl_91', '🔭', 'Le télescope',
      'The telescope', 'Vois loin devant.', 'See far ahead.'),
